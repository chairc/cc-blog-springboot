...
public class WebSocketServerConfig {
    ...
    public static void broadCastInfo(Object object){
        try {
    ...
    public static void sendMessage(Object object, String sessionId){
        try {
            ...
            log.error("指定Session发送消息出错：{}", e.getMessage());
            e.printStackTrace();
        }
    }
}
