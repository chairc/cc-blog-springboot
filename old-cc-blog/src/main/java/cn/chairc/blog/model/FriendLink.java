...
public class FriendLink {
    ...
    private String friend_link_user_head_image_url;     //  友链用户名头像
    ...
    public String getFriend_link_user_head_image_url() {
        return friend_link_user_head_image_url;
    }

    public void setFriend_link_user_head_image_url(String friend_link_user_head_image_url) {
        this.friend_link_user_head_image_url = friend_link_user_head_image_url;
    }
    ...
    public String toString() {
        return "FriendLink{" +
                ...
                ", friend_link_user_head_image_url='" + friend_link_user_head_image_url + '\'' +
